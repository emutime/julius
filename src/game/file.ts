...
import { building_storage_reset_building_ids } from 'building/storage';
import { city_data_init } from 'city/data';
import { city_data_init_scenario } from 'city/data';
import { city_data_init_campaign_mission } from 'city/data';
import { emperor_gift } from 'city/emperor';
import { city_emperor_init_scenario } from 'city/emperor';
import { city_map_set_entry_point } from 'city/map';
import { city_map_set_exit_point } from 'city/map';
...
import { city_message_init_problem_areas } from 'city/message';
import { city_message_clear_scroll } from 'city/message';
import { city_military_determine_distant_battle_city } from 'city/military';
import { city_mission_should_save_start } from 'city/mission';
...
import { city_view_init } from 'city/view';
import { city_view_reset_orientation } from 'city/view';
import { language_type } from 'core/locale';
import { locale_translate_rank_autosaves } from 'core/locale';
import { encoding_type } from 'core/encoding';
import { encoding_system_uses_decomposed } from 'core/encoding';
...
import { file_has_extension } from 'core/file';
import { file_append_extension } from 'core/file';
import { file_remove_extension } from 'core/file';
import { file_exists } from 'core/file';
import { color_t } from 'graphics/color';
import { image } from 'core/image';
import { image_load_climate } from 'core/image';
import { image_load_enemy } from 'core/image';
...
import { empire_init_scenario } from 'empire/empire';
...
import { figure_route_clean } from 'figure/route';
import { traders_clear } from 'figure/trader';
import { figure_create_fishing_points } from 'figuretype/animal';
import { figure_create_herds } from 'figuretype/animal';
import { figure_create_flotsam } from 'figuretype/water';
import { game_animation_init } from 'game/animation';
import { game_file_io_read_scenario } from 'game/file_io';
import { game_file_io_read_saved_game } from 'game/file_io';
import { game_file_io_write_saved_game } from 'game/file_io';
import { game_file_io_delete_saved_game } from 'game/file_io';
...
import { setting_player_name } from 'game/settings';
import { setting_set_personal_savings_for_mission } from 'game/settings';
import { game_state_init } from 'game/state';
import { game_state_unpause } from 'game/state';
...
import { map_random_clear } from 'map/random';
import { map_random_init } from 'map/random';
...
import { map_terrain_clear } from 'map/terrain';
import { map_tiles_update_all_rocks } from 'map/tiles';
import { map_tiles_determine_gardens } from 'map/tiles';
import { map_tiles_update_all_plazas } from 'map/tiles';
import { map_tiles_update_all_walls } from 'map/tiles';
import { map_tiles_update_all_roads } from 'map/tiles';
import { map_tiles_update_all_empty_land } from 'map/tiles';
import { map_tiles_update_all_meadow } from 'map/tiles';
import { map_tiles_update_all_water } from 'map/tiles';
import { map_tiles_update_all_aqueducts } from 'map/tiles';
import { map_tiles_update_all_earthquake } from 'map/tiles';
import { map_tiles_update_all_elevation } from 'map/tiles';
import { map_tiles_add_entry_exit_flags } from 'map/tiles';
...
import { scenario_distant_battle_set_roman_travel_months } from 'scenario/distant_battle';
import { scenario_distant_battle_set_enemy_travel_months } from 'scenario/distant_battle';
...
import { scenario_map_init_entry_exit } from 'scenario/map';
...
import { scenario_set_name } from 'scenario/property';
import { scenario_set_player_name } from 'scenario/property';
import { scenario_restore_campaign_player_name } from 'scenario/property';
import { scenario_property_climate } from 'scenario/property';
import { scenario_property_start_year } from 'scenario/property';
import { scenario_property_enemy } from 'scenario/property';
...
let MISSION_PACK_FILE: char[] = new Array().fill("mission1.pak");
let MISSION_SAVED_GAMES: char[] = new Array(32).fill({
    "Citizen.sav",
    "Clerk.sav",
    "Engineer.sav",
    "Architect.sav",
...
function load_custom_scenario(scenario_name: number, scenario_file: char) {
...
function start_scenario(scenario_name: number, scenario_file: char) {
...
export function game_file_start_scenario(scenario_file: char) {
...
export function game_file_load_scenario_data(scenario_file: char) {
