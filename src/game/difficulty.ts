...
import { set_difficulty, setting_difficulty } from 'game/settings';
...
let data = [
    new difficulty_level(300, 40, 70, 80), // very easy
    new difficulty_level(200, 60, 60, 70), // easy
    new difficulty_level(150, 80, 50, 60), // normal
    new difficulty_level(100, 100, 50, 50), // hard
    new difficulty_level(75, 120, 40, 40) // very hard
];
