...
import { city_gods_reset, MAX_GODS } from 'city/gods';
import { buffer, buffer_read_i16, buffer_read_i32, buffer_read_i8, buffer_read_raw, buffer_read_u8, buffer_write_i16, buffer_write_i32, buffer_write_i8, buffer_write_raw, buffer_write_u8 } from 'core/buffer';
...
export function city_data_init() {
    memset(city_data, 0);
...
export function city_data_init_scenario() {
...
export function city_data_init_campaign_mission() {
...
function save_entry_exit(entry_exit_xy: buffer, entry_exit_grid_offset: buffer) {
...
function load_entry_exit(entry_exit_xy: buffer, entry_exit_grid_offset: buffer) {
...
export function city_data_save_state(main: buffer, faction: buffer, faction_unknown: buffer, graph_order: buffer, entry_exit_xy: buffer, entry_exit_grid_offset: buffer) {
    save_main_data(main);
...
export function city_data_load_state(main: buffer, faction: buffer, faction_unknown: buffer, graph_order: buffer, entry_exit_xy: buffer, entry_exit_grid_offset: buffer) {
    load_main_data(main);
