import { COLOR_FONT_ORANGE } from 'graphics/color';
import { COLOR_FONT_ORANGE_LIGHT } from 'graphics/color';
...
import { touch_get_latest } from 'input/touch';
import { touch_not_click } from 'input/touch';
...
import { building_construction_size } from 'building/construction';
import { building_construction_in_progress } from 'building/construction';
import { building_construction_start } from 'building/construction';
import { building_construction_is_updatable } from 'building/construction';
import { building_construction_cancel } from 'building/construction';
import { building_construction_update } from 'building/construction';
import { building_construction_place } from 'building/construction';
import { building_construction_reset_draw_as_constructing } from 'building/construction';
...
import { city_view_scroll } from 'city/view';
import { city_view_get_selected_tile_pixels } from 'city/view';
import { city_view_pixels_to_view_tile } from 'city/view';
import { city_view_set_selected_view_tile } from 'city/view';
import { city_view_tile_to_grid_offset } from 'city/view';
import { city_view_get_viewport } from 'city/view';
import { city_view_is_sidebar_collapsed } from 'city/view';
import { warning_type } from 'city/warning';
import { city_has_warnings } from 'city/warning';
...
import { formation_legion_move_to } from 'figure/formation_legion';
import { formation_legion_return_home } from 'figure/formation_legion';
import { formation_legion_at_grid_offset } from 'figure/formation_legion';
import { formation_legion_at_building } from 'figure/formation_legion';
...
import { game_state_toggle_paused } from 'game/state';
...
import { scroll_set_custom_margins } from 'input/scroll';
import { scroll_restore_margins } from 'input/scroll';
...
import { city_with_overlay_draw } from 'widget/city_with_overlay';
import { city_with_overlay_get_tooltip_text } from 'widget/city_with_overlay';
import { city_without_overlay_draw } from 'widget/city_without_overlay';
import { widget_minimap_invalidate } from 'widget/minimap';
import { widget_minimap_handle_mouse } from 'widget/minimap';
...
function draw_cancel_construction_button() {
    ...
    let x_offset: number = width - 4 * BLOCK_SIZE;
