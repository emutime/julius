...
import { game_state_overlay, overlay as overlay_t } from 'game/state';
...
import OVERLAY_WATER = overlay_t.OVERLAY_WATER;
import OVERLAY_RELIGION = overlay_t.OVERLAY_RELIGION;
import OVERLAY_FIRE = overlay_t.OVERLAY_FIRE;
import OVERLAY_DAMAGE = overlay_t.OVERLAY_DAMAGE;
import OVERLAY_CRIME = overlay_t.OVERLAY_CRIME;
import OVERLAY_ENTERTAINMENT = overlay_t.OVERLAY_ENTERTAINMENT;
import OVERLAY_THEATER = overlay_t.OVERLAY_THEATER;
import OVERLAY_AMPHITHEATER = overlay_t.OVERLAY_AMPHITHEATER;
import OVERLAY_COLOSSEUM = overlay_t.OVERLAY_COLOSSEUM;
import OVERLAY_HIPPODROME = overlay_t.OVERLAY_HIPPODROME;
import OVERLAY_EDUCATION = overlay_t.OVERLAY_EDUCATION;
import OVERLAY_SCHOOL = overlay_t.OVERLAY_SCHOOL;
import OVERLAY_LIBRARY = overlay_t.OVERLAY_LIBRARY;
import OVERLAY_ACADEMY = overlay_t.OVERLAY_ACADEMY;
import OVERLAY_BARBER = overlay_t.OVERLAY_BARBER;
import OVERLAY_BATHHOUSE = overlay_t.OVERLAY_BATHHOUSE;
import OVERLAY_CLINIC = overlay_t.OVERLAY_CLINIC;
import OVERLAY_HOSPITAL = overlay_t.OVERLAY_HOSPITAL;
import OVERLAY_TAX_INCOME = overlay_t.OVERLAY_TAX_INCOME;
import OVERLAY_FOOD_STOCKS = overlay_t.OVERLAY_FOOD_STOCKS;
import OVERLAY_DESIRABILITY = overlay_t.OVERLAY_DESIRABILITY;
import OVERLAY_NATIVE = overlay_t.OVERLAY_NATIVE;
import OVERLAY_PROBLEMS = overlay_t.OVERLAY_PROBLEMS;
