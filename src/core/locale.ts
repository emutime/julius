...
let NEW_GAME_ENGLISH: number[] = new Array().fill({ 0x4e, 0x65, 0x77, 0x20, 0x47, 0x61, 0x6d, 0x65, 0});
let NEW_GAME_FRENCH: number[] = new Array().fill({ 0x4e, 0x6f, 0x75, 0x76, 0x65, 0x6c, 0x6c, 0x65, 0x20, 0x70, 0x61, 0x72, 0x74, 0x69, 0x65, 0});
let NEW_GAME_GERMAN: number[] = new Array().fill({ 0x4e, 0x65, 0x75, 0x65, 0x73, 0x20, 0x53, 0x70, 0x69, 0x65, 0x6c, 0});
let NEW_GAME_GREEK: number[] = new Array().fill({ 0xcd, 0xdd, 0xef, 0x20, 0xd0, 0xe1, 0xe9, 0xf7, 0xed, 0xdf, 0xe4, 0xe9, 0});
let NEW_GAME_ITALIAN: number[] = new Array().fill({ 0x4e, 0x75, 0x6f, 0x76, 0x61, 0x20, 0x70, 0x61, 0x72, 0x74, 0x69, 0x74, 0x61, 0});
let NEW_GAME_SPANISH: number[] = new Array().fill({ 0x4e, 0x75, 0x65, 0x76, 0x61, 0x20, 0x70, 0x61, 0x72, 0x74, 0x69, 0x64, 0x61, 0});
let NEW_GAME_PORTUGUESE: number[] = new Array().fill({ 0x4e, 0x6f, 0x76, 0x6f, 0x20, 0x6a, 0x6f, 0x67, 0x6f, 0});
let NEW_GAME_POLISH: number[] = new Array().fill({ 0x4e, 0x6f, 0x77, 0x61, 0x20, 0x67, 0x72, 0x61, 0});
let NEW_GAME_RUSSIAN: number[] = new Array().fill({ 0xcd, 0xee, 0xe2, 0xe0, 0xff, 0x20, 0xe8, 0xe3, 0xf0, 0xe0, 0});
let NEW_GAME_SWEDISH: number[] = new Array().fill({ 0x4e, 0x79, 0x74, 0x74, 0x20, 0x73, 0x70, 0x65, 0x6c, 0});
let NEW_GAME_TRADITIONAL_CHINESE: number[] = new Array().fill({ 0x83, 0x80, 0x20, 0x84, 0x80, 0x20, 0x85, 0x80, 0});
let NEW_GAME_SIMPLIFIED_CHINESE: number[] = new Array().fill({ 0x82, 0x80, 0x20, 0x83, 0x80, 0x20, 0x84, 0x80, 0});
let NEW_GAME_KOREAN: number[] = new Array().fill({ 0xbb, 0xf5, 0x20, 0xb0, 0xd4, 0xc0, 0xd3, 0});
let NEW_GAME_JAPANESE: number[] = new Array().fill({ 0x83, 0x6a, 0x83, 0x85, 0x81, 0x5b, 0x83, 0x51, 0x81, 0x5b, 0x83, 0x80, 0});
let NEW_GAME_CZECH: number[] = new Array().fill({ 0x4e, 0x6f, 0x76, 0xe1, 0x20, 0x68, 0x72, 0x61, 0});
