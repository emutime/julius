...
export function file_has_extension(filename: char, extension: char) {
...
export function file_change_extension(filename: char, new_extension: char) {
    let c: char;
    do {
        c = * filename;
        filename++;
...
export function file_append_extension(filename: char, extension: char) {
    let c: char;
    do {
        c = * filename;
        filename++;
...
export function file_remove_extension(filename: number) {
    let c: number;
    do {
        c = * filename;
        filename++;
...
export function file_exists(filename: char, localizable: number) {
