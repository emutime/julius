...
let HIGH_TO_UTF8_DEFAULT: letter_code[] = new Array(HIGH_CHAR_COUNT).fill({
...
let HIGH_TO_UTF8_EASTERN: letter_code[] = new Array(HIGH_CHAR_COUNT).fill({
    { 0x80, 3, { 0xe2, 0x82, 0xac}},
{ 0x81, 1, { 0x3f} },
{ 0x82, 3, { 0xe2, 0x80, 0x9a} },
{ 0x83, 1, { 0x3f} },
...
let HIGH_TO_UTF8_CZECH: letter_code[] = new Array(HIGH_CHAR_COUNT).fill({
    { 0x80, 1, { 0x3f}},
{ 0x81, 1, { 0x3f} },
{ 0x82, 1, { 0x3f} },
{ 0x83, 1, { 0x3f} },
...
let HIGH_TO_UTF8_CYRILLIC: letter_code[] = new Array(HIGH_CHAR_COUNT).fill({
    { 0x80, 2, { 0xd0, 0x82}},
{ 0x81, 2, { 0xd0, 0x83} },
{ 0x82, 3, { 0xe2, 0x80, 0x9a} },
{ 0x83, 2, { 0xd1, 0x93} },
...
let HIGH_TO_UTF8_GREEK: letter_code[] = new Array(HIGH_CHAR_COUNT).fill({
    { 0x80, 3, { 0xe2, 0x82, 0xac}},
{ 0x81, 1, { 0x3f} },
{ 0x82, 3, { 0xe2, 0x80, 0x9a} },
{ 0x83, 2, { 0xc6, 0x92} },
