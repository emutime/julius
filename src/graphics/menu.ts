...
import { unbordered_panel_draw } from 'graphics/panel';
export function menu_bar_draw(items: menu_bar_item, num_items: number, max_width: number) {
...
function get_menu_bar_item(m: mouse, items: menu_bar_item, num_items: number) {
    for (let i: number = 0; i < num_items; i++) {
...
export function menu_bar_handle_mouse(m: mouse, items: menu_bar_item, num_items: number, focus_menu_id: number) {
...
function calculate_menu_dimensions(menu: menu_bar_item) {
...
export function menu_draw(menu: menu_bar_item, focus_item_id: number) {
...
function get_menu_item(m: mouse, menu: menu_bar_item) {
    let y_offset: number = TOP_MENU_HEIGHT + MENU_BASE_TEXT_Y_OFFSET * 2;
    for (let i: number = 0; i < menu.num_items; i++) {
...
export function menu_handle_mouse(m: mouse, menu: menu_bar_item, focus_item_id: number) {
...
export function menu_update_text(menu: menu_bar_item, index: number, text_number: number) {
