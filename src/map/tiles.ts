import { city_map_entry_flag, city_map_exit_flag, city_map_set_entry_flag, city_map_set_exit_flag } from 'city/map';
...
import { GRID, map_grid_bound_area, map_grid_delta, map_grid_is_inside, map_grid_offset } from 'map/grid';
import { map_image_at, map_image_set } from 'map/image';
import { map_image_context_get_aqueduct, map_image_context_get_dirt_road, map_image_context_get_earthquake, map_image_context_get_elevation, map_image_context_get_paved_road, map_image_context_get_shore, map_image_context_get_wall, map_image_context_get_wall_gatehouse, terrain_image } from 'map/image_context';
import { map_point, map_tile } from 'map/point';
import { map_property_clear_constructing, map_property_clear_plaza_or_earthquake, map_property_is_alternate_terrain, map_property_is_plaza_or_earthquake, map_property_mark_draw_tile, map_property_mark_plaza_or_earthquake, map_property_set_multi_tile_size, map_property_set_multi_tile_xy } from 'map/property';
