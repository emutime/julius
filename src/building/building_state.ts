...
import { building, building_is_house } from 'building/building';
import { building_type } from 'building/type';
import { buffer, buffer_read_i16, buffer_read_i32, buffer_read_i8, buffer_read_u16, buffer_read_u8, buffer_skip, buffer_write_i16, buffer_write_i32, buffer_write_i8, buffer_write_u16, buffer_write_u8 } from 'core/buffer';
...
export function building_state_save_to_buffer(buf: buffer, b: building) {
    ...
    buffer_write_i16(buf, b.subtype.house_level);
    ...
    buffer_write_i8(buf, b.sentiment.house_happiness);
    buffer_write_u8(buf, b.show_on_problem_overlay);
}
function read_type_data(buf: buffer, b: building) {
    if (building_is_house(b.type)) {
        for (let i: number = 0; i < INVENTORY_MAX; i++) {
...
export function building_state_load_from_buffer(buf: buffer, b: building) {
    ...
    b.subtype.house_level = buffer_read_i16(buf);
    ...
    b.sentiment.house_happiness = buffer_read_i8(buf);
