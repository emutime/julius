...
let scrollbar: scrollbar_type = { 580, 72, 352, 560, NUM_VISIBLE_OPTIONS, on_scroll, 1};
...
let hotkey_widgets: hotkey_widget[] = new Array().fill({
...
let hotkey_buttons: generic_button[] = new Array().fill({
