...
import { city_victory_state, city_victory_stop_governing, victory_state } from 'city/victory';
import { game_mission_peaceful } from 'game/mission';
import { setting_clear_personal_savings, setting_set_personal_savings_for_mission, setting_victory_video } from 'game/settings';
...
import { inner_panel_draw, large_label_draw, outer_panel_draw } from 'graphics/panel';
import { text_draw_number } from 'graphics/text';
import { window_id, window_show, window_type } from 'graphics/window';
import { hotkeys } from 'input/hotkey';
import { input_go_back_requested } from 'input/input';
import { mouse, mouse_in_dialog, mouse_reset_up_state } from 'input/mouse';
import { scenario_campaign_mission, scenario_campaign_rank, scenario_is_custom, scenario_is_tutorial_1, scenario_is_tutorial_2, scenario_save_campaign_player_name, scenario_set_campaign_mission, scenario_set_campaign_rank } from 'scenario/property';
...
let fired_buttons: generic_button[] = [
    new generic_button(80, 224, 480, 25, button_fired, button_none, 0, 0),
];
