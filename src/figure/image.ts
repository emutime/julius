...
let CORPSE_IMAGE_OFFSETS: number[] = new Array(128).fill({
...
let MISSILE_LAUNCHER_OFFSETS: number[] = new Array(128).fill({
...
let CART_OFFSETS_X: number[] = new Array().fill({ 13, 18, 12, 0, - 13, -18, -13, 0});
let CART_OFFSETS_Y: number[] = new Array().fill({- 7, -1, 7, 11, 6, -1, -7, -12});
