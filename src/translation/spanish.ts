...
let all_strings: translation_string[] = new Array().fill({
...
void translation_spanish(c);
export function translation_spanish(strings: translation_string, num_strings: number) {
    um_strings = sizeof(al;
    gs) / sizeof(translation_string);
}
;
}
